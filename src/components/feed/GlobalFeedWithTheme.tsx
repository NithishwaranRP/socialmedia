              ...
              style={[
                style,
                {
                  color: modAnim.interpolate({
                    inputRange: [0, 0.5, 1],
                    outputRange: [colors.text === '#000' ? '#aaaaaa' : '#555555', colors.text, colors.text === '#000' ? '#aaaaaa' : '#555555'],
                  }),
                },
              ]}
            >
...
const currentHashtag = endlessHashtags || allHashtags;
  ...
  return (
      ...
      {thumbnails.length > 1 ? (
        ...
        const startAutoScroll = () => {
          ...
          autoScrollIntervalRef.current = setInterval(() => {
            ...
            scrollPosition.current += 1.5 * scrollDirection.current;
            ...
            scrollViewRef.current?.scrollTo({ 
              ...
              animated: false // Use false for animated to avoid jerkiness
            });
    ...
    return (
      ...
      >
        <StatusBar barStyle={colors.text === '#000' ? "dark-content" : "light-content"} backgroundColor={colors.background} translucent />
        <View>
          <View
            ref={breakingNewsRef}
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    isActive && [styles.activeCategory, { backgroundColor: colors.text === '#000' ? '#e0e0e0' : '#202020' }],
                  ]}
                >
                  {/* Number before the thumbnail - with improved numbering logic */}
                  <Text style={[styles.numberDisplay, { color: colors.text === '#000' ? 'rgba(0,0,0,0.7)' : 'rgba(255,255,255,0.7)' }]}>
                    {displayNumber}
                  </Text>
                  ...
                  <View style={styles.categoryTextContainer}>
                    <Text style={[styles.categoryText, { color: colors.text }, isActive && styles.activeCategoryText]}>
                      {displayHashtag}
                    </Text>
                  </View>
...
thumbnailContainer: {
  ...
  activeCategory: {
    backgroundColor: colors.text === '#000' ? '#e0e0e0' : '#202020',
    borderColor: '#4099ff',
    borderWidth: 1,
  },
  activeCategoryText: {
