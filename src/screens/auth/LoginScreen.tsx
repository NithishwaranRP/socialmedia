...
const BackgroundImage = require('../../assets/images/login_onboard.jpg');
    ...
    <ImageBackground source={BackgroundImage} style={styles.background} resizeMode="stretch">
      <View style={styles.googleButtonContainer}>
        <SocialButtonHorizontal
          ...
          onPress={async () => await dispatch(signInWithGoogle())}
          text="Continue with Google"
          textColor="#FFF"  // ✅ Changed text color to white
          backgroundColor="transparent"  // ✅ Removed white background
          borderColor="#FFF"  // ✅ Added white border
          borderWidth={0.5}  // ✅ Adjust border thickness as needed
        />
      </View>
    </ImageBackground>
  );
...
const styles = StyleSheet.create({
  ...
  googleButtonContainer: {
    position: 'absolute',
    bottom: RFValue(60),  // ✅ Moves button to the bottom
    left: 0,
    right: 0,
    alignItems: 'center',
